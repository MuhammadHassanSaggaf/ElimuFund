        ...
        <div className="terms-content">
          ...
          <div className="terms-sections">
            <section id="acceptance" className="terms-section">
              ...
              <p>
                By accessing and using ElimuFund's platform, you acknowledge
            ...
            <section id="purpose" className="terms-section">
              ...
              <p>
                ElimuFund is an educational crowdfunding platform that connects
                generous donors with students seeking financial assistance for
                their education. Our mission is to make quality education
                accessible through transparent, secure, and accountable funding
                processes.
              </p>
            </section>
              ...
              <div className="responsibility-cards">
                <div className="responsibility-card donor">
                  ...
                  <ul>
                    ...
                    <li>
                      Understand that donations are voluntary and non-refundable
                    </li>
                ...
                <div className="responsibility-card student">
                  ...
                  <ul>
                    ...
                    <li>
                      Use funds exclusively for stated educational purposes
                    </li>
            ...
            <section id="privacy" className="terms-section">
              ...
              <p>
                ...
                information. We collect only necessary information to facilitate
                the funding process and will never share your data with third
            ...
            <section id="disputes" className="terms-section">
              ...
              <p>
                In the event of any disputes or concerns, please contact our
                support team first. We are committed to resolving issues fairly
                and promptly through mediation. If necessary, disputes will be
