  ...
  const [reports] = useState([
    {
      ...
      grade: "A-",
      description:
        "Completed first semester with excellent performance in Mathematics and Science.",
    ...
    },
    {
      ...
      grade: "B+",
      description:
        "Maintaining good academic standing. Participating in science club activities.",
      attachments: [],
    },
  ]);
